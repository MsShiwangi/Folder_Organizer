...
def clean_folder(folder_path):
    for filename in os.listdir(folder_path):
        if os.path.isfile(os.path.join(folder_path,filename)):
            # print((os.path.join(folder_path,filename)))  for printing all files of the folder
...
if __name__ == "__main__":
    ...
    # print("Enter the path of the folder need to be organised:")
    folder_path=input("Enter the path of the folder need to be organised:\n")

    # folder_path ='C:/Users/shiva/Downloads'
